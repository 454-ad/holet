...
<script type="text/javascript">
	...
	function callPay(node) {
		...
		window.location.href = "${pageContext.request.contextPath }/order?method=callPay&orders=${sessionScope.orders}";
	}
</script>
</head>
		...
		<div id="dish_class">
			<div id="dish_top">
				<ul>
					...
					<li><a href="${pageContext.request.contextPath }/order?method=sayOrder">
