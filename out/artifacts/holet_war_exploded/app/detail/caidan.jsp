	...
	<div id="all">
		<div id="menu">
			...
			<div id="foot">
				     ...
				     &nbsp;&nbsp;
				<a href="${pageContext.request.contextPath }/index?method=getMenu&page=1">首页</a>
				<a href="${pageContext.request.contextPath }/index?method=getMenu&page=${requestScope.pageUtils.prevPage}">上一页 </a>
				<a href="${pageContext.request.contextPath }/index?method=getMenu&page=${requestScope.pageUtils.nextPage}">下一页 </a>
				<a href="${pageContext.request.contextPath }/index?method=getMenu&page=${requestScope.pageUtils.lastPage}">末页</a>
		...
		<div id="dish_class">
			<div id="dish_top">
				...
				<li class="dish_num"></li>
					<li>
						<a href="${pageContext.request.contextPath }/order?method=sayOrder">
			...
			<div id="dish_2">
				<ul>
					<c:forEach items="${requestScope.foodtypes}" var="type">
						<li>
							<a href="${pageContext.request.contextPath }/index?method=getTypeFood&foodtype=${type.id}">${type.typeName}</a>
						</li>
					</c:forEach>
				</ul>
			</div>
