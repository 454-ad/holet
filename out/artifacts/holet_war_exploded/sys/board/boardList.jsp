...
<div id="QueryArea">
	<form action="${pageContext.request.contextPath }/table" method="post">
		...
		<input type="text" name="keyword" title="请输入餐桌名称" value="${requestScope.keyword }">
    ...
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
		...
		<c:forEach items="${requestScope.list }" var="table" varStatus="vs">
			<tr class="TableDetail1">
				...
				<%--<c:out value="${table.tableStatus}"></c:out>--%>
				<c:choose>
				...
				<td>
					...
					<a href="${pageContext.request.contextPath }/table?method=del&id=${table.id}" onClick="return delConfirm();"class="FunctionButton">删除</a>				
				</td>
			</tr>
        </c:forEach>
