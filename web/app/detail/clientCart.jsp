...
<head>
	...
	<script type="text/javascript">
		...
		function removeSorder(fid) {
			// var fid = node.lang;
			window.location.href ="${pageContext.request.contextPath }/order?method=removeOrder&fid="+fid;
		}
		// 修改菜品项数量
		function alterSorder(node) {
			var snumber = node.value;
			var fid = node.lang;
			window.location.href = "${pageContext.request.contextPath }/order?method=alterSorder&fid="+fid+"&snumber="+snumber;
		}
		// 下单
			...
			<div id="count">
				<table align="center" width="100%">
					...
					<tr height="60">
					 		...
					 		<td align="center" width="20%">
					 			<input type="button" value="删除" class="btn_next"  onclick="removeSorder(${entry.key.id})" />
					 		</td>
